...
function RegisterRoutes(app) {
    ...
    // ###########################################################################################################
    const argsproductController_webhook = {};
    app.get('/api/product/webhook', ...((0, runtime_1.fetchMiddlewares)(productController_1.productController)), ...((0, runtime_1.fetchMiddlewares)(productController_1.productController.prototype.webhook)), function productController_webhook(request, response, next) {
